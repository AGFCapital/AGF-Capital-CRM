...
function cardActions(lead) {
  ...
  if (lead.stage === "aprovado") return button("invite-sent", "Convite enviado");
  ...
  if (lead.stage === "agendamento") return button("copy-scheduling", "Copiar mensagem de agenda");
  if (lead.stage === "call_marcada") return button("create-project-now", "Criar projeto");
  return "";
}
